...
class Economy(commands.Cog):
   ...
   async def economy_money(self, interaction: discord.Interaction):
      if self.started:
         ...
         await interaction.response.send_message("Use '/economy_start' first to use this command")
   ...
   @economy_work.error
   async def on_economy_work_error(self, interaction: discord.Interaction, error: app_commands.AppCommandError):
   ...
   @economy_crime.error
   async def on_economy_crime_error(self, interaction: discord.Interaction, error: app_commands.AppCommandError):
      if isinstance(error, app_commands.CommandOnCooldown):
         await interaction.response.send_message(error)
   ...
   async def ecoomy_deposit(self, interaction: discord.Interaction, money: int):
      if self.started:
         ...
         await interaction.response.send_message("You need first use '/economy_start'")
